...
Collection.prototype.update = function(spec, document, options, callback) {
  console.log(__filename, ': update: doc ' , document, ': spec, ' , spec);
  var args = Array.prototype.slice.call(arguments, 2);
 // console.log(__filename, ': spec: ', spec, ': args = ', Array.prototype.slice.call(arguments, 0), ', callback = ', callback);
  callback = args.pop();
...
Collection.prototype.find = function() {
  ...
  console.log(__filename, ': find: options = ', options, ', fields = ', fields, ', query: ', selector);
  var o = options;
  try {
    ...
    console.log(__filename, ': find error: ', err, 'options = ', options, ', fields = ', fields, ', query: ', selector);
    callback(err);
  }
};
