...
CPPPATH_NODE = '/Users/dave/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
...
HAVE_CAIRO = 1
LIBDIR = '/Users/dave/.node_libraries'
LIBPATH_CAIRO = ['/opt/local/lib']
LIBPATH_NODE = '/Users/dave/local/node/lib'
LIBPATH_ST = '-L%s'
LIB_CAIRO = ['cairo']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/dave/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/dave/local/node'
