...
module.exports = function(path) {
    ...
    for (var image_data_index = 0; image_data_index < image_data_length; image_data_index += 4) {
        ...
        if (rgb_h_index.hasOwnProperty(rgb_key)) {
            var hsv = rgb_h_index[rgb_key];
        } else {
            var hsv = colors.rgb_to_h(image_data[image_data_index], image_data[image_data_index + 1], image_data[image_data_index + 2]);
            rgb_h_index[rgb_key] = hsv;
        }
        h_data.push(hsv);
