...
module.exports = exports = {
    ...
    mixins: {
        ...
        put: function(data, callback) {
            ...
            if (this.config.coll) {
                if (data._id) {
                    data._id = this._as_oid(data._id);
                    var crit = {_id: data._id};
                    self.find(crit, function(err, result){
                        if (result && result.length){
                            self.update( data, _after_put);
                        } else {
                            self.insert(data, _after_put);
                        }
                    });
                } else {
                    this.insert(data, _after_put);
                }
            } else {
            ...
            if (this.config.coll) {
                ...
                if (options) {
                    if (options.hasOwnProperty('fields')) {
                        ...
                        this.config.coll.find(query, fields, options, callback);
                    } else {
