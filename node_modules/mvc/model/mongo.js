    ...
    mixins: {
        ...
        put: function(data, callback) {
            ...
            function _post_insert(err, result){
                console.log(__filename, ': post insert: ', err, ', result ', result);
                if (err){
            ...
            if (this.config.coll) {
              ...
              //      console.log(__filename, ': putting with ID: ', data);
                ...
                this.config.coll.save(data, _post_insert);
            } else {
        ...
        update: function(data, callback, filter, options) {
            if (this.config.coll) {
                ...
                console.log(__filename + ':: -------------------- update updating where ', filter, ': data = ', data, '; options = ', options);
