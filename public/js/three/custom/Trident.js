...
THREE.Trident = function ( params /** Object */) {
	...
	this.add( getSegment( new THREE.Vector3(params.length,0,0), params.xAxisColor ) );
	this.add( getSegment( new THREE.Vector3(0,params.length,0), params.yAxisColor ) );
	this.add( getSegment( new THREE.Vector3(0,0,params.length), params.zAxisColor ) );
