...
MARS_ANI.TextGeometry = function (text, parameters) {
    ...
    MARS_ANI.log(['TextGeometry', 'start'], 'shapes made');
    ...
    MARS_ANI.log(['TextGeometry', 'end'], 'done');
...
window._typeface_js = { faces: MARS_ANI.FontUtils.faces, loadFace: MARS_ANI.FontUtils.loadFace };
