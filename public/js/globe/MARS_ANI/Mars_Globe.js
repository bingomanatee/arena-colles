    ...
    MARS_ANI.Mars_Globe.prototype = {
        ...
        material: function() {
            if (!this._mat) {
                ...
                uniforms[ "tNormal" ].texture = THREE.ImageUtils.loadTexture('/img/globe/normal_x_16.png'); //"/examples/textures/normal/ninja/normal.jpg");
               ...
               uniforms[ "tDisplacement" ].texture = THREE.ImageUtils.loadTexture("/img/globe/height_x_32.png");
                uniforms[ "tDiffuse" ].texture = THREE.ImageUtils.loadTexture("/img/globe/color_x_16.png");
