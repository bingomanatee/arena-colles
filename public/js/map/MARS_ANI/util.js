MARS_ANI._util_exe = function () {
    ...
    MARS_ANI.res.colors = {
        red: c.setRGB(1, 0, 0).getHex(),
        yellow : c.setRGB(1, 1, 0).getHex(),
        blue : c.setRGB(0, 0, 1).getHex(),
        green : c.setRGB(0, 1, 0).getHex(),
        orange : c.setRGB(1, 0.5, 0).getHex(),
        purple : c.setRGB(0.5, 0, 1).getHex(),
        magenta : c.setRGB(1, 0, 1).getHex(),
        white : c.setRGB(1, 1, 1).getHex(),
        gray : c.setRGB(0.5, 0.5, 0.5).getHex(),
