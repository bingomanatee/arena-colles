MARS_ANI._config_exe = function() {
    ...
    MARS_ANI._init_objects = function() {
        ...
        MARS_ANI.scene.addObject(new THREE.Trident());
        MARS_ANI.log(['init', 'Mars', 'start'], 'creating globe');

        MARS_ANI.mars = new MARS_ANI.Mars_Globe();
        MARS_ANI.mars.create();
        var mars_mesh = MARS_ANI.mars.mesh();
        MARS_ANI.scene.addObject(mars_mesh);
    ...
    MARS_ANI._init_lights = function() {
        ...
        MARS_ANI.scene.addObject(MARS_ANI.sun);
        MARS_ANI.scene.addObject(MARS_ANI.moon);
        ...
        MARS_ANI.uni.add(MARS_ANI.sun_obj);
        MARS_ANI.uni.add(MARS_ANI.moon_obj);
        MARS_ANI.scene.addObject(MARS_ANI.uni);
    ...
    MARS_ANI._init_camera = function() {
         MARS_ANI.camera = new THREE.PerspectiveCamera(
               30,
                 MARS_ANI.scene_width / MARS_ANI.scene_height,
               100,
                MARS_ANI.mars_radius * 10000
        );
        MARS_ANI.scene.add(MARS_ANI.camera);
    }
/**
...
*/
    ...
    MARS_ANI.animator.queue.add_task('camera_movement', function() {
      //     MARS_ANI.camera.rotation.y += 0.01;
        console.log('rotating camera');
                  MARS_ANI.camera.rotation.z+= 0.1;
    })
